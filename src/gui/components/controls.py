...
def create_alert(
    message: str, color: str = "info", dismissable: bool = True
) -> dbc.Alert:
    """
                    ...
                    dbc.Row(
                        [
                            dbc.Col(
                                [
                                    html.H4(
                                        "0.00", id="total-mwh", className="text-info"
                                    ),
                            ...
                            dbc.Col(
                                [
                                    html.H4(
                                        "0.00", id="total-mah", className="text-warning"
                                    ),
...
def format_statistics(stats: Dict[str, Any]) -> html.Div:
    ...
    return (
        html.Div(items)
        if items
        else html.P("No statistics available", className="text-muted")
    )
